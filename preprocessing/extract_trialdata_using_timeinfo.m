function data = extract_trialdata_using_timeinfo(gazedir, block, trialtype)
%
% -----------------------------------------------------------------------
...
raw = fileread(fullfile(gazedir, ['autism_v1_20210524_' block '_' trialtype '_0'], 'metadata.json'));

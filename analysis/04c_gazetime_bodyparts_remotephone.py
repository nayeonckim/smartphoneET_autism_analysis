...
for ses in range(10):
    ...
    prepdata_dir = os.path.join(root_dir,'remotephone','down2frame_session' + ses )
    # Directory to save outputs.
    output_dir = os.path.join(root_dir,'results','BodyPart_GazeTime_RemotePhone_ses' + ses ) 
    # Videos to compute gaze times.
    vidclips = ['LXX01.mp4', 'L'+sesNum+'02.mp4', 'L'+sesNum+'03.mp4', 'LXX04.mp4', 'L'+sesNum+'05.mp4', 'L'+sesNum+'06.mp4', 'L'+sesNum+'07.mp4', 'L'+sesNum+'08.mp4', 'L'+sesNum+'09.mp4']   
	        ...
	        for sii, subj_ii in enumerate(subjs):
	            ...
	            if this_et_xy[0] < 0 or this_et_xy[1] < 0: 
	                ...
	                if frame_results is not None and img_layers_red is not None:
	                    ...
	                    # need to compare to "if np.any(img_layers_nonheadbody)" 
